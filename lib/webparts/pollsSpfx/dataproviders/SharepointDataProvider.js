...
var SharepointDataProvider = (function () {
    ...
    SharepointDataProvider.prototype.readsPollItemsFromList = function (pollsAnswered) {
        ...
        var querygetAllItems = "https://oaktondidata.sharepoint.com/tstPoll/_api/Web/Lists/getByTitle('Poll Questions')/Items?&$select=ID,Question,Options,Published_x0020_Date,Expiry_x0020_Date,PollCount&$filter=(Expiry_x0020_Date ge datetime'" + todaysDate + "') and (Published_x0020_Date le datetime'" + todaysDate + "')";
