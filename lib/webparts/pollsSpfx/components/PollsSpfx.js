...
var PollsSpfx = (function (_super) {
    ...
    PollsSpfx.prototype.componentDidMount = function () {
        ...
        this.props.sharepointdataProvider.getCurrentUser().then(function (item) {
            console.log("Fetched user details");
            _this.props.sharepointdataProvider.getPollLogByUser(item.Id).then(function (pollitems) {
                console.log("Fetched Poll answered details");
                _this.props.sharepointdataProvider.readsPollItemsFromList(pollitems)
                    .then(
                //resolve
                function (items) {
                    _this.setState({
            ...
            React.createElement("div", { className: PollsSpfx_module_scss_1.default.container },
                ...
                React.createElement("div", { className: PollsSpfx_module_scss_1.default.row },
                    React.createElement("div", { className: PollsSpfx_module_scss_1.default.columnbuttons },
                        ...
                        React.createElement(Button_1.DefaultButton, { "data-automation-id": 'test', onClick: this._onVoteClick, hidden: pollitem.Showresults, title: 'Vote', disabled: pollitem.Showresults }, " Vote "),
